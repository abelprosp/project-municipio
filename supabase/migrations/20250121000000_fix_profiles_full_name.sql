-- Migration para garantir que a coluna full_name existe na tabela profiles
-- Esta migration adiciona full_name se não existir e migra dados de name para full_name se necessário
